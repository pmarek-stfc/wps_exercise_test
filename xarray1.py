...
files_path = '/home/pmarek/badc/cmip5/data/cmip5/output1/MOHC/HadCM3/rcp45/mon/atmos/Amon/r1i1p1/latest/tas'
file_path_absolute = os.path.join(os.environ.get('HOME'), files_path)
files = glob.glob(file_path_absolute + '/*.nc')
#
